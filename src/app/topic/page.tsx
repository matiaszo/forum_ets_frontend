...
export default function Topic() {
  ...
  const [topic, setTopic] = useState<Topic>({
    ...
    idSection: 1,
    mainComment: {
      user: { id: "1", name: "Instrutor", instructor: true, image: "ezij8xyotmpsaudzlday" },
    ...
    comments: [
      {
        ...
        user: { id: "2", name: "Usuário", instructor: false, image: "ezij8xyotmpsaudzlday" },
        mention: null,
        likes: 3,
      },
    ],
    ...
    <div className="h-screen mt-20 font-robFont">
      ...
      <div className="flex m-10 flex-col">
        <div className="flex flex-col items-center rounded-xl p-3 font-robFont mb-3 text-black">
          ...
          <div className="flex flex-col border-blue5 border-2 w-full rounded-md m-10">
            <textarea
              name="ans"
              id="ans"
              value={newReply}
          ...
          {topic.comments.map((comment) => (
            <div key={comment.id} className="mb-5 w-full">
              <Answer
                comment={comment}
