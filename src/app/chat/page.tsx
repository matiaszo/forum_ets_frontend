  ...
  const sendMessage = async () => {
    ...
    const newMsg: Message = {
      ...
      user: {
        ...
        name: "Você",
        instructor: Number(localStorage.getItem("id")) === 1,
      },
    };
        ...
        <div className="flex flex-col rounded-lg items-center justify-start min-h-[100%] w-[70%] bg-alice">
          {chat ? (
            <>
              ...
              <div className="flex flex-col bg-alice rounded-md w-[100%] p-4 h-[85%] overflow-y-auto" style={{ maxHeight: "70vh" }}>
                {chat.messages.map((msg) => (
                  ...
                  >
                    ...
                    {msg.user.id === Number(localStorage.getItem("id")) && (
                      <CldImage
                        src={msg.user.image || "xjlzp7la2pcpac629a85"}
                        alt={msg.user.name}
                        width={40}
                        height={40}
                        radius={40}
                ...
                {isUpload && (
                  <>
                    <div className={`flex items-center mb-4 justify-end`}>
                      ...
                      <div className="flex flex-col max-w-[70%]">
                        <div className="text-sm text-blue2 ml-3 font-bold">{JSON.parse(localStorage.getItem("user") || '{}')?.name || "segsnhic8wvgxhmcmj5w"}</div>
                        <div className={`p-3 rounded-lg text-white ml-3 bg-blue2`}>
                          <p className="font-robCondensed">
                            <CldImage
                            src={upload ? upload : "segsnhic8wvgxhmcmj5w"}
                            alt={"arquivo"}
                            width={200}
                            height={200}
                            radius={10}
                      ...
                      <CldImage
                        // src={upload ? upload : "segsnhic8wvgxhmcmj5w"}
                        src={JSON.parse(localStorage.getItem("user") || '{}')?.image || "segsnhic8wvgxhmcmj5w"}
                        alt={"arquivo"}
                        width={40}
                        height={40}
                        radius={40}
              ...
              <div className="flex w-[90%] mt-4 mb-5">
                ...
                <button className="px-4 py-2 bg-blue2 text-white rounded-md" onClick={sendMessage}>
                  Enviar
                </button>
              </div>
            </>
